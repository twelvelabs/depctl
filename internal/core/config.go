...
const (
	ConfigPathDefault = ".dependencies.yml"
	ConfigPathEnv     = "DEPCTL_CONFIG"
)

type Config struct {
	ConfigPath   string
	Color        bool         `yaml:"color" env:"DEPCTL_COLOR" default:"true"`
	Debug        bool         `yaml:"debug" env:"DEPCTL_DEBUG"`
	Prompt       bool         `yaml:"prompt" env:"DEPCTL_PROMPT" default:"true"`
	LogLevel     string       `yaml:"log_level" env:"DEPCTL_LOG_LEVEL" default:"warn" validate:"oneof=debug info warn error fatal"` //nolint: lll
